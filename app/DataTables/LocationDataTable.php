...
class LocationDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('image', function ($query) {
            ...
            if ($query->location_image !== null) {
                return '<img width="70" src="' . asset($query->location_image) . '" alt="Location Image">';
            } else {
                return '<img width="70" src="' . asset('default/location.webp') . '" alt="Default Location Image">';
            }
        })
        ...
        ->rawColumns(['image', 'background', 'action','parent_location' , 'show_at_home', 'status'])
            ->setRowId('id');
    }
